...
namespace clientWpf
{
    class SyncCommand
    {
        ...
        /* Whatever the constructor is, first is called the basic constructor of SyncCommand to initilize the class fields*/
        ...
        {
            return JsonConvert.SerializeObject(this); //serialize .NET object in a Json String
        }
